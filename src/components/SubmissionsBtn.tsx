const SubmissionsBtn = ({ text }: { text: string }) => {
  return (
    <div>
      <style>
        {`
          .button {
            --white: #ffffff;
            --bg: #2d2d2d; /* Dark gray background to match the theme */
            --radius: 100px;
            outline: none;
            cursor: pointer;
            border: 0;
          ...
          .button .wrap {
            font-size: 25px;
            font-weight: 500;
            color: rgba(255, 255, 255, 0.7); /* Light text for visibility */
            padding: 32px 45px;
